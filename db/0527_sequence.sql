...
------------------------------------------------------------------------------------시퀀스
--시퀀스: 번호 자동 생성기, 시퀀스도 하나의 객체임
--create sequence 시퀀스명
--start with 시작값 0(보통 0부터 시작)
--increment by 증가값 1(보통 1)
--maxvalue 최댓값
--minvalue 최솟값
--cycle | nocycle 반복여부
--cache | nocache

--부서번호 deptno의 sequence를 생성
create sequence dept_deptno_sequence01;
select dept_deptno_sequence01.nextval from dual;
select dept_deptno_sequence01.currval from dual;
