	...
	public void deptEdit() {
		...
		try {
			...
			if (rowCnt > 0) {
				...
				System.out.println("회원 이름" + dept2.getEmployee_name() + "  ) : ");
				String employee_name = ManageMain.sc.nextLine();

				System.out.println("닉네임 ( " + dept2.getPhonenumber() + "  ) : ");
				String phonenumber = ManageMain.sc.nextLine();
				System.out.println("동호회명 ( " + dept2.getAddress() + "  ) : ");
				String address = ManageMain.sc.nextLine();
				System.out.println("전화번호 ( " + dept2.getEmail() + "  ) : ");
				String email = ManageMain.sc.nextLine();
				System.out.println("주소 ( " + dept2.getCom_name() + "  ) : ");
				String com_name = ManageMain.sc.nextLine();
				System.out.println("이메일 ( " + dept2.getDept() + "  ) : ");
				String dept = ManageMain.sc.nextLine();
				System.out.println("이메일 ( " + dept2.getJob() + "  ) : ");
