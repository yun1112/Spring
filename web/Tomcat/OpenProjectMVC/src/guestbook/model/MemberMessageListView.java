...
public class MemberMessageListView {
	...
	// 메시지 리스트
	private List<MemberMessage> messageList;
	// 전체 페이지의 개수
	...
	public MemberMessageListView(
			int messageTotalCount, 
			int currentPageNumber, 
			List<MemberMessage> messageList,
	...
	public List<MemberMessage> getMessageList() {
		return messageList;
	}
